...
These data are available in the file `ptc_tasting`. You can access this data frame by running the command
```{r}
  load(url("https://byuistats.github.io/M221R/data/L18.RData"))
```
in R. 

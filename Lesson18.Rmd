...
## Make Females first in PTC.

## NEED TO CHANGE INSTRUCTIONS IN CI below
...
We can see that the two proportions are fairly close to each other: $\hat p_1 = \frac{51}{66} = 0.773, \hat p_2 = \frac{38}{52} = 0.731$.

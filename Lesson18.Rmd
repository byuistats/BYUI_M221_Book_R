...
The $P$-value$= 0.00000742 < 0.05 = \alpha$, so we reject the null hypothesis.
...
- Use [`prop.test(x=c( ,  ), y=c(  ,  ), correct=FALSE, alternative="two.sided")`](Lesson18.html#r-instructions-for-testing-two-proportions) to perform a hypothesis test of two proportions. 

- Use [`prop.test(x=c(  ,  ), y=c(  ,  ), correct=FALSE, conf.level=0.95)`](Lesson18.html#r-instructions-for-confidence-interval-of-the-difference-of-two-proportions) to obtain a confidence interval for the difference of two proportions.

...
```{r}
hist(BodyTemp$BodyTemp, main="Body Temperatures", xlab="Degrees Fahrenheit", col="steelblue")
```
...
```{r}
hist(SurveyData$Wage, xlab="Hourly Wages", main="BYU-Idaho Student Survey Results", col="yellow3")
```

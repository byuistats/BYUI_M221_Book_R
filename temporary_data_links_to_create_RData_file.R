...
# MysteryInvestmentOpportunities
library(readxl)
url <- "https://byuistats.github.io/BYUI_M221_Book/Data/MysteryInvestmentOpportunities.xlsx"
destfile <- "MysteryInvestmentOpportunities.xlsx"
curl::curl_download(url, destfile)
MysteryInvestmentOpportunities <- read_excel(destfile)

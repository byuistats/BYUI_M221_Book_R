...
* Load the data: `gratitude`. You can access this data frame by running the command
...
Data representing the results of this study are given in the data frame `soccer_shoes`.

...
- The variances are equal for each group.
    ...
    This requirement is checked by examining the standard deviations. Remember, the variance is the square of the standard deviation. If the variances are equal, the standard deviations will be equal. The rule we will use is: *if the largest standard deviation is more than twice as big as the smallest standard deviation, we will conclude that the variances are equal.* 
    
    For the gratitude study, the three standard deviations were 0.848, 0.944, and 0.832 for the Events, Grateful, and Hassles groups, respectively. The largest of these variances is 0.944 and the smallest is 0.832. Notice that the largest standard deviation is not more than twice as big as the smallest standard deviation. So, we conclude the assumption is satisfied.
...
* The largest standard deviation (7.291) is not four times the smallest (5.216), so the assumption of equal variances is satisfied.
</div>
<br>
...
- We can conduct ANOVA testing when the following requirements are satisfied:
    ...
    3. The variance is constant.
        - This is satisfied when the largest standard deviation is not more than four times the smallest.

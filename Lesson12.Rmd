...
* Read in the data to RStudio if you haven't already: [PineBeetle](./Data/PineBeetle.xslx) 
...
* Use the code `t.test(differences, conf.level=0.95)` to set the desired confidence level and create the confidence interval.

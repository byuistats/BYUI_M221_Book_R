...
```{r}
flight_costs$difference <- flight_costs$fourteen_days - flight_costs$ninety_days
...
```{r}
flight_costs$difference2 <- flight_costs$ninety_days - flight_costs$fourteen_days
hist(flight_costs$difference2, 
     col = "brown3",

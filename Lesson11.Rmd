...
boxplot(body_temp$temperature,       # Select the data to use for the graph
        ...
        main = "Body Temperatures of 148 Healthy Adults")
```
In both these plots, there is evidence that the mean is not 98.6 degrees Fahrenheit but some lower value. We will test this formally using a one-sample $t$-test.

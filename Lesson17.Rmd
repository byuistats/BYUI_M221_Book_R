...
**Step 1.** Use RStudio to run the code in the file [functions.R](./scripts/functions.R). This will load a function that will allow you to compute the hypothesis test for one proportion. You can do this by running the command <br>

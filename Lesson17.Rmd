...
**Step 3.** Use `one_prop_test(...)` as follows to run the One Sample t Test in R.
...
As you can see from the output above, the requirements are satisfied for the PTC data:
$$
\begin{array}{ll}

...
A ward Primary president recorded the gender and age of each child in her Primary. The data are given below in a wide format.
...
The data can also be organized in a "long" format. 
...
### R Instructions for Numerical Summaries of Two Groups (Wide Data)
...
<div class = "Software">
**To compute numerical summaries for two groups (wide data):**

Read the data into RStudio: [copd_rehab.xlsx](./data/copd_rehab.xlsx)
...
We next compute our "favorite" summary statistics for each of the two columns of data separately. 
...
### R Instructions for Side-by-Side Boxplots (Wide Data)
...
## Hypothesis Tests for Wide Data

### R Instructions for an Independent Samples t Test (Wide Data)
...
```{r}
t.test(copd_rehab$community, copd_rehab$hospital, alternative = "two.sided")
```
...
## Confidence Intervals for Wide Data 

### R Instructions for a Confidence Interval of the Difference of Two Means (Wide Data)

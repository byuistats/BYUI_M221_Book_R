...
Read the data into RStudio: [copd_rehab.xlsx](./data/copd_rehab.xlsx). Then, follow the directions to [convert the data into long format](#convert_wide_to_long). Save the results in a data frame called `copd`.
...
* First, read the data into RStudio: [copd_rehab.xlsx](./data/copd_rehab.xlsx). Then, follow the directions to [convert the data into long format](#convert_wide_to_long). Save the results in a data frame called `copd`.

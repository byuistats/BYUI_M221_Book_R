...
* We need to find the the following: $\bar x_1$, $s_1$, $n_1$, $\bar x_2$, $s_2$, and $n_2$. So we read in the [fifa_heart_attacks.xlsx](./data/fifa_heart_attacks.xlsx) data into RStudio. (Review of [reading in data](RHelp.html#reading-in-the-data).) 

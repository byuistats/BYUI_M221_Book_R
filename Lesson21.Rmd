...
Correlation coefficients are always between $-1$ and $1$, and a correlation of $0$ implies *no correlation* in the data. We use the letter $r$ to write the correlation coefficient.
...
The correlation coefficient $r$ is always a value between $-1$ and $1$.  If there is a strong positive association, the correlation coefficient will be close to $1$.  If the correlation coefficient is positive but relatively close to 0, we say there is a weak positive association in the data.  

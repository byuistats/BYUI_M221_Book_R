...
```{r}
plot(math_self_efficacy$score ~ math_self_efficacy$confidence_rating_mean)
```
...
```{r, echo = FALSE}
plot(Score ~ ConfidenceRatingMean, data = math_self_efficacy,
     col = "steelblue3", #specify the color
     pch = 16, #choose a plotting symbol, options are 1, 2, ..., 25.
     xlab = "Mean Confidence Rating for Each Student",
     ylab = "Exam Score of Each Student (Out of 100 Pts.)",
...
lm1 <- lm(Score ~ ConfidenceRatingMean, data = math_self_efficacy)

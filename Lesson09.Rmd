...
Download these data from https://byuistats.github.io/M221R/data/ethan_allen.xlsx.
...
```{r, include = FALSE}
library(openxlsx)
ethan_allen <- read.xlsx("https://byuistats.github.io/M221R/data/ethan_allen.xlsx")
```
...
Dr. Bunch summarized the responses in a figure, <!--\cite{Bunch03}--> from which the data were extracted.  These data are given in the data file at https://byuistats.github.io/M221R/data/cardiac_arrest.xlsx.
You can [click here](https://byuistats.github.io/M221R/RHelp.html#Reading_in_Data) for instructions on how to import the dataset into R.

```{r, include = FALSE}
library(openxlsx)
cardiac_arrest <- read.xlsx("https://byuistats.github.io/M221R/data/cardiac_arrest.xlsx")
```

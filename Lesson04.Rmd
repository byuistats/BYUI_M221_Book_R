...
- Read in the dataset [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx). If needed, you can review the instructions on reading in data from [Lesson 2: Reading Data into R](Lesson02.html#Reading-Data-into-R).
...
- Open the data file you are using if you haven't already. For this example, continue using the file [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx) that you opened previously in this lesson.
...
- Open the data file you are using. For this example, continue using the [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx) data that you opened previously in this lesson.
...
boxplot(surgery_lawsuits$wrong_site/1000, horizontal=TRUE, xlab="Cost in Thousands of Dollars", col="seagreen")
```
...
<div class="QuestionsHeading">Answer the following questions:</div>
<div class="Questions">
29. Create a histogram of the **wrong-patient** lawsuit data, located in column B of  the file [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx). What is the shape of the wrong-patient data?
...
hist(surgery_lawsuits$wrong_patient, col="skyblue", main="Costs of Lawsuites for Wrong Patient Operations", xlab="Cost in Dollars")
```
...
boxplot(surgery_lawsuits$wrong_patient, horizontal=TRUE, col="orange", main="Lawsuites for Wrong Patient Operations", xlab="Cost in Dollars")
```
...
boxplot(surgery_lawsuits$wrong_site/1000000, surgery_lawsuits$wrong_patient/1000000, names=c("Wrong Site", "Wrong Patient"), col=c("skyblue3","firebrick"), main="Cost to Hospital by Lawsuit Type", ylab="Cost in Millions of Dollars", las=1)
```
...
- Open the data file you are using. For this example, open the file [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx).

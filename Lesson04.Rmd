...
----------------------------------------------------------------------------------------------
  ...
  When we rewrite this lesson, we should:
    ...
    - Acoid comparing two groups (i.e., wrong site v. wrong patient)
...
Here is a link to the [R Script for Lesson 4](./scripts/lesson04.R]).
...
- Open the "surgery_lawsuits" data.
Download these data from https://byuistats.github.io/M221R/data/surgery_lawsuits.xlsx.
...
```{r, include = FALSE}
library(openxlsx)
surgery_lawsuits <- read.xlsx("https://byuistats.github.io/M221R/data/surgery_lawsuits.xlsx")
```
...
- Open the data file you are using if you haven't already. For this example, continue using the data frame "surgery_lawsuits" that you loaded previously in this lesson. If you have not already done it, please download these data from https://byuistats.github.io/M221R/data/surgery_lawsuits.xlsx.
You can [click here](https://byuistats.github.io/M221R/RHelp.html#Reading_in_Data) for instructions on how to import the dataset into R.
...
- Open the data file you are using. For this example, continue using the "surgery_lawsuits" data frame that you opened previously in this lesson.  If you need to load this data frame, download the data from https://byuistats.github.io/M221R/data/surgery_lawsuits.xlsx.
You can [click here](https://byuistats.github.io/M221R/RHelp.html#Reading_in_Data) for instructions on how to import the dataset into R.

...
<a href="javascript:showhide('oc')">[Show/Hide Outcomes]{style="font-size:8pt;"}</a>
...
<a href="javascript:showhide('su')">[Show/Hide Summaries]{style="font-size:8pt;"}</a>
...
-   The **covariance** is a measure of how two variables vary together. The formula for the covariance is $s_{xy}=r \cdot s_x \cdot s_y$. <br>
:::
...
-   For bivariate inference we use software to calculate the sample coefficients, residuals, test statistic, $P$-value, and confidence intervals of the true linear regression coefficients. <br>
:::

---
title: "Lesson 10: Confidence Interval for One Mean (Sigma Known)"
output:
  html_document:
    theme: cerulean
    toc: true
...
* Compute a confidence interval for a single mean with σ known using the following steps:
  ...
  + Create a confidence interval from the point estimate and the margin of error
  + Check the requirements of the confidence interval
  + Interpret a confidence interval for one mean with σ known
...
[Normal Probability Applet](http://statistics.byuimath.com/index.php?title = Normal_Probability_Applet).
...
- To find the value of $z^*$, given a specific confidence level, do the following:
  + *Open the applet at [Normal Probability Applet](http://statistics.byuimath.com/index.php?title = Normal_Probability_Applet)
...
$$
Another way to state this question is to ask, between what two $z$-scores will 90% of the data in a standard normal distribution fall?  We need to find the values of $-z$ and $z$ such that the area between them is equal to 0.90.  Again, we use the [Normal Probability Applet](http://statistics.byuimath.com/index.php?title = Normal_Probability_Applet).

...
2. Paste the following text into the lower left corner of the RStudio screen. Look for a `>` symbol below the word Console.

```{}
mydata <- c(1, 1, 2, 3, 5, 8, 13)
mean(mydata)
```

3. Then press Return. It should give the following answer:

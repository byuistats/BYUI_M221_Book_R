...
- Read in the dataset. Download these data from https://byuistats.github.io/M221R/Data/surgery_lawsuits.xlsx.
...
- In RStudio, select the "Environment" pane, click on "Import Dataset", and then choose "From Excel..." from the menu that appears. Like this:

<center>
<img src="./Images/rstudio_import_excel.png" width="500">
</center>

<--- CHANGE THE INSTRUCTIONS FOR READING IN DATA TO INCLUDE DOWNLOADING THE FILE ---!>
<--- CHANGE THE INSTRUCTIONS FOR READING IN DATA TO INCLUDE DOWNLOADING THE FILE ---!>
<--- CHANGE THE INSTRUCTIONS FOR READING IN DATA TO INCLUDE DOWNLOADING THE FILE ---!>
<--- CHANGE THE INSTRUCTIONS FOR READING IN DATA TO INCLUDE DOWNLOADING THE FILE ---!>
<--- CHANGE THE INSTRUCTIONS FOR READING IN DATA TO INCLUDE DOWNLOADING THE FILE ---!>
...
- We can calculate the average (mean) of any quantitative column of the data frame `surgery_lawsuits` using the `mean(...)` function and the selection operator `$` as follows. If we want the mean of the `wrong_site` column, we enter the following in the Console:
...
Now, try computing the mean of the `wrong_patient` data.

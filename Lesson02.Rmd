...
- Read in the dataset. For this example, open the data file by right clicking on this link: [surgery_lawsuits.xlsx](./data/surgery_lawsuits.xlsx) and then selecting "Copy link address".

...
* Obtain access to software tools for statistical analysis
...
## Verify R and RStudio are Properly Installed

<div class="SoftwareHeading">R Instructions</div>
<div class="Software" style="padding:10px;">

<a href="javascript:showhide('r_instr_2_mean')"><span style="font-size:8pt;">Show/Hide R Instructions</span></a>
<div id="r_instr_2_mean">  <!--  style="display:none;" -->

<br>
**Check R and RStudio have been installed correctly**  by calculating the average of some data values. To do this, follow these steps:
<br />
...
<img src="./Images/rstudio_demo_mean.png" width="500">

...
Load the `estuarine_crocodiles` data frame by running the command
```{r}
...
- Load the data frame `estuarine_crocodiles` into R by running the command
`load(url("https://byuistats.github.io/M221R/data/L23.RData"))`
...
<div class = "Software">
- Load the data into R: `estuarine_crocodiles` You can access this data frame by running the command
`load(url("https://byuistats.github.io/M221R/data/L23.RData"))`
in R. 
- Perform a linear regression using the `lm( )` function.
...
<div class = "SoftwareHeading">Excel Instructions</div>
<div class = "Software">
- Load the `estuarine_crocodiles` data into R using the command
`load(url("https://byuistats.github.io/M221R/data/L23.RData"))`
- Perform a linear regression using the `lm( )` function.
...
- Read the data into R: `estuarine_crocodiles`. You can access this data frame by running the command
`load(url("https://byuistats.github.io/M221R/data/L23.RData"))`
in R. 
- Perform a linear regression using the `lm( )` function.

...
The data from the study are given in the file `chiropractic_care_raw`. Download these data from https://byuistats.github.io/M221R/data/chiropractic_care_raw.xlsx.
...
```{r, include = FALSE}
library(openxlsx)
chiropractic_care_raw <- read.xlsx("https://byuistats.github.io/M221R/data/chiropractic_care_raw.xlsx")
```
...
First, read in the data from the file `chiropractic_care_raw`. Download these data from https://byuistats.github.io/M221R/data/chiropractic_care_raw.xlsx.
You can [click here](https://byuistats.github.io/M221R/RHelp.html#Reading_in_Data) for instructions on how to import the dataset into R.
...
We make a contingency table using the `table()` command. We give the two columns of data using the format `dataframe$variable`. In our case, we will create a contingency table of the `chiropractic_care_raw$location` and `chiropractic_care_raw$motivation` data.

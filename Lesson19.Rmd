...
The data from the study are given in the file `chiropractic_care_raw`. You can access this data frame by running the command
```{r}
...
First, read in the data from the file `chiropractic_care_raw`. You can access this data frame by running the command
`load(url("https://byuistats.github.io/M221R/data/L19.RData"))`
in R. 

...
The proportion of heads tossed by the first student in the file [coin_heads.xlsx](./data/coin_heads.xlsx) is $\widehat p = 0.68$.
...
<div class="QuestionsHeading">Answer the following questions:</div>
<div class="Questions">
11. The second student with data listed in the file [coin_heads.xlsx](./data/coin_heads.xlsx) had $\widehat p = 0.44$, or 44% of their coin tosses resulted in heads.  Find the $z$-score corresponding to this value.
